      ...
      <div>
        <div className="flex justify-between flex-col lg:flex-row md:flex-row items-center px-4 lg:px-0 md:px-0">
          <ul className="text-[#0F160F]/70 lg:w-[50%] md:w-[50%] w-[90%]">
            <li className="lg:text-[24px] md:text-[24px] text-[18px] list-disc mb-4 ">
              <strong>Sign Up and Get Started</strong>: Begin by signing up on
              the Usedy platform. Join a community of eco-conscious individuals
              dedicated to making a positive impact on the environment.
            </li>
            <li className="lg:text-[24px] md:text-[24px] text-[18px] list-disc mb-4 ">
              <strong>
                Proceed to sell or buy button to post or buy Recyclable Products
              </strong>
            ...
            <li className="lg:text-[24px] md:text-[24px] text-[18px] list-disc mb-4 ">
              <strong>Secure Blockchain Payment</strong>: As a buyer your
              payment is secured on the blockchain. Escrow service holds
              cryptocurrency until a buyer confirms receipt of recyclable
              materials
            </li>
          </ul>
